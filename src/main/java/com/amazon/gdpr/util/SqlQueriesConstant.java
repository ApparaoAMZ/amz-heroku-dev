...
public class SqlQueriesConstant {
	...
	public static String MODULE_MGMT_LAST_RUN = "SELECT RMM.MODULE_ID, RMM.RUN_ID, RMM.MODULE_NAME, RMM.SUBMODULE_NAME, RMM.MODULE_STATUS, "
			+ "RMM.MODULE_COMMENTS, RM.RUN_STATUS FROM GDPR.RUN_MODULE_MGMT RMM, GDPR.RUN_MGMT RM WHERE RM.RUN_ID = RMM.RUN_ID AND "
			+ "RM.RUN_STATUS = 'RE-RUN' AND RM.RUN_ID = ? ORDER BY RMM.MODULE_ID ASC";
	...
	public static String RUN_SUMMARY_MGMT_DEPER_FETCH = "SELECT SUMMARY_ID, RUN_ID, CATEGORY_ID, COUNTRY_CODE, IMPACT_TABLE_ID, IMPACT_TABLE_NAME, "
			+ " BACKUP_QUERY, DEPERSONALIZATION_QUERY, TAGGED_QUERY FROM GDPR.RUN_SUMMARY_MGMT WHERE RUN_ID = ? AND "
			+ " (DEPERSONALIZATION_ROW_COUNT IS NULL OR DEPERSONALIZATION_ROW_COUNT < TAGGED_ROW_COUNT) "
