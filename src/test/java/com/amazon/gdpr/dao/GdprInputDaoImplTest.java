...
public class GdprInputDaoImplTest {
	...
	private List<Category> lastCategoryData(){
		...
		//To Cover Setter and getters
		Category category6= new Category();
		category6.setCategoryId(1);
		category6.setCategoryName("ACCESS CONTROL");
		category6.setGdprCategoryStatusField("ACTIVE");
		category6.setGdprCategoryStatusField("");
		category6.getCategoryId();
		category6.getCategoryName();
		category6.getGdprCategoryStatusField();
		category6.getStatus();
		return lstAnonymizationDetailUpdated;
	...
	private List<AnonymizationDetail> lstAnonymizationDetailData() {
		...
		AnonymizationDetail anonymizationDetail3 = new AnonymizationDetail(34, 3, 0, "EUR-EU", "BEL", "PRIVACY DELETED",
				"ACTIVE");
		anonymizationDetail3.setAnonymizationDetailId(34);
		anonymizationDetail3.setCategoryId(1);
		anonymizationDetail3.setCountryCode("AUT");
		anonymizationDetail3.setImpactFieldId(3);
		anonymizationDetail3.setRegion("EUR-E");
		anonymizationDetail3.setStatus("ACTIVE");
		anonymizationDetail3.setTransformation("NULL");
		anonymizationDetail3.getAnonymizationDetailId();
		anonymizationDetail3.getCategoryId();
		anonymizationDetail3.getCountryCode();
		anonymizationDetail3.getImpactFieldId();
		anonymizationDetail3.getRegion();
		anonymizationDetail3.getStatus();
		anonymizationDetail3.getTransformation();
		anonymizationDetail3.toString();
		lstAnonymizationDetailUpdated.add(anonymizationDetail2);
		lstAnonymizationDetailUpdated.add(anonymizationDetail1);
		return lstAnonymizationDetailUpdated;
	...
	private List<ImpactTableDetails> lstImpactTableDetails(){
		...
		ImpactTableDetails lstImpactTableDetails7 = new ImpactTableDetails("RESPONSE__C", "INTERVIEWER_COMMENT__C",
				"TEXT");
		//Set data using setters
		ImpactTableDetails lstImpactTableDetails8= new ImpactTableDetails("RESPONSE__C", "INTERVIEWER_COMMENT__C",
				"TEXT");
		lstImpactTableDetails8.setImpactColumnName("RESPONSE__C");
		lstImpactTableDetails8.setImpactColumnType("INTERVIEWER_COMMENT__C");
		lstImpactTableDetails8.setImpactTableName("TEXT");
		lstImpactTableDetails8.toString();
