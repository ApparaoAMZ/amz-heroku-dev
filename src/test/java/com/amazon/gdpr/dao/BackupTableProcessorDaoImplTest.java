...
public class BackupTableProcessorDaoImplTest {
	...
	BackupTableDetails lstBackupTableDetails3= new BackupTableDetails("bkp_interview__c",
			"candidate_last_name__c");
	lstBackupTableDetails3.setBackupTablecolumnn("candidate_last_name__c");
	lstBackupTableDetails3.setBackupTableName("bkp_application__c");
	lstBackupTableDetails3.toString();
