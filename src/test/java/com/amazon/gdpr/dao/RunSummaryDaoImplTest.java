...
public class RunSummaryDaoImplTest {
	...
	public void fetchRunSummaryDetailTest() {
		...
		RunSummaryMgmt runSummaryMgmt1 = new RunSummaryMgmt(1L, 1, "EUR-EU", "AUT", 2, "APPLICATION__C",
				"select * from APPLICATION_C..", " Alter Table APPLICATION_C..");
		RunSummaryMgmt runSummaryMgmt2 = new RunSummaryMgmt(1L, 1, "EUR-EU", "AUT", 3, "INTERVIEW__C",
				"select * from APPLICATION_C..", " Alter Table APPLICATION_C..");
		...
		//List<RunSummaryMgmt> lstRunSummaryMgmtRes = 
				runSummaryDaoImpl.fetchRunSummaryDetail(anyInt(),anyString());
	}
