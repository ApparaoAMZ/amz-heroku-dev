...
public class TagQueryProcessorTest {
	...
	private List<ImpactTable> lstImpactTable() {
		...
		ImpactTable impactTable5 = new ImpactTable(9, "SF_ARCHIVE", "RESPONSE__C", "ID", "CHILD", "SF_ARCHIVE",
				"APPLICATION__C", "APPLICATION__C", "SFID");
		impactTable5.setImpactTableId(9);
		impactTable5.setImpactSchema("SF_ARCHIVE");
		impactTable5.setImpactTableName("RESPONSE__C");
		impactTable5.setImpactColumns("ID");
		impactTable5.setImpactTableType("CHILD");
		impactTable5.setParentSchema("SF_ARCHIVE");
		impactTable5.setParentTable("APPLICATION__C");
		impactTable5.setImpactTableColumn("APPLICATION__C");
		impactTable5.setParentTableColumn("SFID");
		impactTable5.getImpactTableId();
		ImpactTable impactTable6 = new ImpactTable(9,"RESPONSE__C","APPLICATION__C","APPLICATION__C","SFID");
