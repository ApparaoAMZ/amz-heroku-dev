...
public class GDPRDataProcessorTest {
	...
	private List<ImpactField> lstImpactFieldData() {
		...
		ImpactField impactField6 = new ImpactField();
		impactField6.setImpactFieldId(5);
		impactField6.setImpactFieldLabel("ESIGNATURE");
		impactField6.setImpactFieldName("ESIGNATURE_READ_GENERAL__C");
		impactField6.setImpactFieldType("TEXT");
		impactField6.setImpactTableId(2);
		impactField6.getImpactFieldId();
		impactField6.getImpactFieldLabel();
		impactField6.getImpactFieldName();
		impactField6.getImpactFieldType();
		impactField6.getImpactTableId();
		impactField6.toString();
